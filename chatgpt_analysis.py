            ...
            messages=[
                {"role": "system", "content": "You are a career coach helping a user evaluate job positions based on their CV."},
                {
                    ...
                    "content": (
                        ...
                        "Please score how well this position fits the user on a scale from 1 to 10, and provide the score only in the format 'X'. Keep in mind that the user would want to utilise his Python and SQL skills in that position. The ideal industry for him would be finance or fintech as he is good in finance."
                    )
                }
            ]
        )
